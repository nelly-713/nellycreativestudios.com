  ...
  try {
    ...
    const res = await fetch('https://api.stripe.com/v1/checkout/sessions', {
      ...
      body: new URLSearchParams({
        ...
        ...(image ? {'line_items[0][price_data][product_data][images][]': image} : {}),
        ...
        'shipping_address_collection[allowed_countries][]': ['US','CA','GB','AU','FR','DE','IT','ES','NL','CH','SE','NO','DK','JP','SG','HK','AE','MX'],
